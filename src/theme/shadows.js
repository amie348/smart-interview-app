...
const createCustomShadow = (color) => {
  ...
  return {
    ...
    black: `0px 0px 15px -7px ${alpha(palette.common.black, 0.2)},0px 0px 20px 3px ${alpha(palette.common.black, 0.2)},0px 9px 46px 8px ${alpha(palette.common.black, 0.2)}`,
    small_black: `0px 0px 7px -2px ${alpha(palette.common.black, 0.2)},0px 0px 2px 1px ${alpha(palette.common.black, 0.2)},0px 1px 5px 1px ${alpha(palette.common.black, 0.2)}`,
  };
};
